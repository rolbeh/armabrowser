...
namespace ArmaServerBrowser.Logic
{
    static class UiTask
    {
        ...
        public static void RunInUi<T1>(Action<T1> action, T1 obj1)
        {
        ...
        public static void RunInUi<T1, T2>(Action<T1, T2> action, T1 obj1, T2 obj2)
        {
        ...
        public static async Task RunInUiAsync<T1, T2>(Action<T1, T2> action, T1 obj1, T2 obj2)
        {
            Tuple<Action<T1, T2>, T1, T2> tuple = new Tuple<Action<T1, T2>, T1, T2>(action, obj1, obj2);

            await _uiTaskFactory.StartNew(t => ((Tuple<Action<T1, T2>, T1, T2>)t).Item1(((Tuple<Action<T1, T2>, T1, T2>)t).Item2, ((Tuple<Action<T1, T2>, T1, T2>)t).Item3), tuple);
        }

        public static async Task RunInUiAsync<T1, T2>(Action<T1, T2> action, T1 obj1, T2 obj2, System.Threading.CancellationToken cancellationToken)
        {
            Tuple<Action<T1, T2>, T1, T2> tuple = new Tuple<Action<T1, T2>, T1, T2>(action, obj1, obj2);
        ...
        public static async Task RunInUiAsync(Action action)
        {
            await _uiTaskFactory.StartNew(action);
        }

        public static async Task RunInUiAsync(Action action, System.Threading.CancellationToken cancellationToken)
        {
            await _uiTaskFactory.StartNew(action, cancellationToken);
        }
