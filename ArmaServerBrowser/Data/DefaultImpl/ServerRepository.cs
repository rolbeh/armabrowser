using ArmaServerBrowser.Data.DefaultImpl.ArmaServerInfo;
using System;
...
namespace ArmaServerBrowser.Data.DefaultImpl
{
    sealed class ServerRepository : IServerRepository
    {
        ...
        public System.Net.IPEndPoint[] GetServerEndPoints()
        {
            ...
            const string r = "ArmaServerBrowser.Resources.gslist.exe";
        ...
        static IServerVo Parse(string data)
        {
            ...
            info.Players = ParseInt(GetValueByKey("numplayers", values));
 ...
 ISO2
    ...
    sealed class ServerRepositoryHtml : IServerRepository
    {
        private ServerRepository _client;

        public ServerRepositoryHtml()
        {
        }
