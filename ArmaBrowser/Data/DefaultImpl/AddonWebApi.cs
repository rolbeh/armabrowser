...
namespace ArmaBrowser.Data.DefaultImpl
{
    ...
    {
        #region public key
        private static readonly byte[] pubBlob = new byte[] {0x6,0x2, 0x0,0x0, 0x0,0xA4, 0x0,0x0, 0x52,0x53, 0x41,0x31, 0x0,0x10, 0x0,0x0, 
        ...
        //const string BaseUrl = @"http://armabrowsertest.fakeland.de/?XDEBUG_SESSION_START=3B978CA5";
        const string BaseUrl = @"http://armabrowser.org/addons/";

        const string A = @"ArmaServerBrowser";
        private const string V = @"1";
        const string AhK = "appkey";
        ...
        public void PostInstalledAddonsKeysAsync()
        {
            ...
            if (queryResult.StatusCode == HttpStatusCode.Unauthorized)
            {
                ...
                offset = DateTime.ParseExact(dateString, "r", CultureInfo.CurrentCulture) - DateTime.UtcNow;
        ...
        [SecurityCritical]
        private static RestRequest htua(TimeSpan offset)
        {
